        ...
        <v-card-text>
          ...
          <p class="text-left">
            <a
              href="https://www.partydash.com/"
              target="_blank"
            >https://runeskype.herokuapp.com/play</a> 
          </p>
          <p class="text-left"> 
            Responisibilities:
          </p>
    ...
    <div class="text-center">
      ...
      >
        ...
        <v-card-text>
          ...
          <p class="text-left"> 
            By entering their zip code in a search field, users will be able to search and access detailed inforabout all candidates running for election in their district. In addition, users can enter their addrfind out where their nearest polling site is located and request transportation on election day.
          </p>
          <p class="text-left"> 
